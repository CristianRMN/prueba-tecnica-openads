 ...
 */
final class Version20250930113857 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enlace CHANGE contenido_id_id contenido_id INT NOT NULL');
        $this->addSql('ALTER TABLE enlace ADD CONSTRAINT FK_8414B2797FDA517C FOREIGN KEY (contenido_id) REFERENCES contenido (id)');
        $this->addSql('CREATE INDEX IDX_8414B2797FDA517C ON enlace (contenido_id)');
        ...
        $this->addSql('DROP INDEX IDX_A01B5DE306221BB ON tarifa');
        $this->addSql('DROP INDEX IDX_A01B5DEBF9F75E0 ON tarifa');
        $this->addSql('ALTER TABLE tarifa ADD proovedor_id INT NOT NULL, ADD medio_id INT NOT NULL, DROP proovedor_id_id, DROP medio_id_id');
        $this->addSql('ALTER TABLE tarifa ADD CONSTRAINT FK_A01B5DE39679F91 FOREIGN KEY (proovedor_id) REFERENCES proovedor (id)');
        $this->addSql('ALTER TABLE tarifa ADD CONSTRAINT FK_A01B5DEA40AA46 FOREIGN KEY (medio_id) REFERENCES medio (id)');
        $this->addSql('CREATE INDEX IDX_A01B5DE39679F91 ON tarifa (proovedor_id)');
        $this->addSql('CREATE INDEX IDX_A01B5DEA40AA46 ON tarifa (medio_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enlace DROP FOREIGN KEY FK_8414B2797FDA517C');
        $this->addSql('DROP INDEX IDX_8414B2797FDA517C ON enlace');
        $this->addSql('ALTER TABLE enlace CHANGE contenido_id contenido_id_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE tarifa DROP FOREIGN KEY FK_A01B5DE39679F91');
        $this->addSql('ALTER TABLE tarifa DROP FOREIGN KEY FK_A01B5DEA40AA46');
        $this->addSql('DROP INDEX IDX_A01B5DE39679F91 ON tarifa');
        $this->addSql('DROP INDEX IDX_A01B5DEA40AA46 ON tarifa');
        $this->addSql('ALTER TABLE tarifa ADD proovedor_id_id INT NOT NULL, ADD medio_id_id INT NOT NULL, DROP proovedor_id, DROP medio_id');
        ...
        $this->addSql('CREATE INDEX IDX_A01B5DE306221BB ON tarifa (medio_id_id)');
        $this->addSql('CREATE INDEX IDX_A01B5DEBF9F75E0 ON tarifa (proovedor_id_id)');
    }
}
